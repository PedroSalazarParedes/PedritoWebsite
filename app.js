...
// Nicolás Cáceres: Recuerda que John nos dijo que es mejor el uso de let y const que el de var:

//This is how we acccess the container that we will 'type' into.
let container = document.getElementById("content");

//The different messages.
const intro_message = "I'm an engineering student at "
  .split("")
  ...
  .concat(" and I'm interested in various topics. Among my interests are literature, liguistics, music, information theory, generative grammars, 3d printing, and the list keeps growing..."
    .split(""));
const contact_info = "You can find me at p.salazar12[at]uniandes.edu.co and @pedrito8472 on "
  .split("")
  .concat(["<a class=\"twitter\" href=\"https://twitter.com/pedrito8472\" target=\"_blank\">twitter</a>"])
  .concat(".".split(""));
const projects = "At the moment I'm working on an autonomous program grading tool called "
  .split("")
